...
class RoutePermissionInventoryTests(unittest.TestCase):
    PUBLIC_GETS = {
        ...
        "/api/assets/{asset_id}",
        "/api/assets/{asset_id}/fields",
        "/api/assets/{asset_id}/ddl",
        "/api/assets/domains",
        "/api/assets/layers",
    ...
    EXPECTED = {
        ...
        ("PUT", "/api/assets/{asset_id}"): "asset:write",
        ("PUT", "/api/assets/{asset_id}/fields"): "asset:write",
        ("DELETE", "/api/assets/{asset_id}"): "asset:write",
