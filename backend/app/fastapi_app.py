...
def create_fastapi_app(
    *,
    ...
    service = indicator_service_instance or indicator_service
    ...
    if "indicator" in set(effective_capabilities.get("enabled_codes") or []):
        _register_indicator_routes(app, service)
    return app
