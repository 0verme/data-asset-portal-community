export const DEFAULT_PROTOCOL_OPTIONS = ["HTTP", "OSS"];
...
const FREQ_INTERVAL_OPTIONS = [
  { value: "5", name: "每 5 分钟" },
  { value: "30", name: "每 30 分钟" },
  { value: "60", name: "每小时" },
];
const FREQ_WEEKDAY_OPTIONS = [
  { value: "1", name: "周一" },
  { value: "2", name: "周二" },
  { value: "3", name: "周三" },
  { value: "4", name: "周四" },
...
const FREQ_MONTHDAY_OPTIONS = [
  ...Array.from({ length: 28 }, (_, index) => ({ value: String(index + 1), name: `${index + 1} 号` })),
  { value: "LAST", name: "月末" },
];

export const FREQ_PARAM_CONFIG = {
