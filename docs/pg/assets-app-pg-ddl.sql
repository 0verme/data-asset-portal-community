...
CREATE UNIQUE INDEX IF NOT EXISTS idx_p_asset_table_uk_01
    ON dwp.p_asset_table (schema_name, table_name);

CREATE INDEX IF NOT EXISTS idx_p_asset_table_ix_01
    ON dwp.p_asset_table (layer_code, domain_code, status_code);

CREATE INDEX IF NOT EXISTS idx_p_asset_table_ix_02
    ON dwp.p_asset_table (owner_name);

CREATE INDEX IF NOT EXISTS idx_p_asset_table_ix_03
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_p_asset_field_uk_01
    ON dwp.p_asset_field (asset_id, field_name);

CREATE INDEX IF NOT EXISTS idx_p_asset_field_ix_01
...
CREATE INDEX IF NOT EXISTS idx_p_asset_change_log_ix_01
    ON dwp.p_asset_change_log (table_name, change_time);

CREATE INDEX IF NOT EXISTS idx_p_asset_change_log_ix_02
