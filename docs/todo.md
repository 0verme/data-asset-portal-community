...
- **界面截图**：README 的「项目预览」目前是占位说明。正式发布前使用零售演示数据（`demo/datasets/`）重新拍摄核心 5~10 张界面截图并恢复 README 引用。
- **发布闭环**：仓库创建、首次 CI 验证、版本 tag 与 Release 发布流程（见 P4 报告的 Open Source Release Closure checklist）。
