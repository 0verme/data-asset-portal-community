...
CREATE UNIQUE INDEX idx_p_code_category_uk_01
    ON dwp.p_code_category (category_code);

CREATE INDEX idx_p_code_category_ix_01
...
CREATE UNIQUE INDEX idx_p_code_item_uk_01
    ON dwp.p_code_item (category_code, item_code);

CREATE INDEX idx_p_code_item_ix_01
