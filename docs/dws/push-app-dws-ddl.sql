...
CREATE UNIQUE INDEX idx_p_push_job_uk_01
    ON dwp.p_push_job (system_id, job_code);

CREATE INDEX idx_p_push_job_ix_01
    ON dwp.p_push_job (system_id, enabled_flag, freq_type);

CREATE INDEX idx_p_push_job_ix_02
...
CREATE UNIQUE INDEX idx_p_push_job_field_uk_01
    ON dwp.p_push_job_field (job_id, field_name);

CREATE INDEX idx_p_push_job_field_ix_01
...
CREATE INDEX idx_p_push_change_log_ix_01
    ON dwp.p_push_change_log (system_id, change_time);

CREATE INDEX idx_p_push_change_log_ix_02
    ON dwp.p_push_change_log (job_id, change_time);

CREATE INDEX idx_p_push_change_log_ix_03
