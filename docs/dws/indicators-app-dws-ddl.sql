...
CREATE UNIQUE INDEX idx_p_indicator_item_uk_01
    ON dwp.p_indicator_item (indicator_id);

CREATE INDEX idx_p_indicator_item_ix_01
    ON dwp.p_indicator_item (dimension_code, status_code, registered_date);

CREATE INDEX idx_p_indicator_item_semantic_ref
...
CREATE UNIQUE INDEX idx_p_indicator_path_config_uk_01
    ON dwp.p_indicator_path_config (path_code);

CREATE UNIQUE INDEX idx_p_indicator_path_config_uk_02
    ON dwp.p_indicator_path_config (full_path);

CREATE INDEX idx_p_indicator_path_config_ix_01
...
CREATE INDEX idx_p_indicator_change_log_ix_01
