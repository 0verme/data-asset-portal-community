...
DISTRIBUTE BY HASH (upstream_system_id);
...
CREATE UNIQUE INDEX idx_p_field_mapping_field_uk_01
    ON dwp.p_field_mapping_field (table_pk, source_field_name, target_field_name);

CREATE INDEX idx_p_field_mapping_field_ix_01
    ON dwp.p_field_mapping_field (target_field_name, mapping_rule);

CREATE INDEX idx_p_field_mapping_field_ix_02
...
CREATE INDEX idx_p_field_mapping_change_log_ix_01
    ON dwp.p_field_mapping_change_log (table_pk, change_time);

CREATE INDEX idx_p_field_mapping_change_log_ix_02
