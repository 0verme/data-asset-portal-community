...
CREATE UNIQUE INDEX idx_p_upstream_system_uk_01
    ON dwp.p_upstream_system (system_id);

CREATE UNIQUE INDEX idx_p_upstream_system_uk_02
    ON dwp.p_upstream_system (system_pk);

CREATE INDEX idx_p_upstream_system_ix_01
...
CREATE UNIQUE INDEX idx_p_upstream_unload_time_uk_01
    ON dwp.p_upstream_unload_time (system_pk, unload_time);

CREATE INDEX idx_p_upstream_unload_time_ix_01
...
CREATE INDEX idx_p_upstream_change_log_ix_01
