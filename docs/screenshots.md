...
- 截图来自 repository Community remote path；如果页面显示 `V0.2.0`，它表示 frontend application/build metadata，不是线上 static Demo 的 `V1.0.0`，也不改变 published GitHub Release `v0.2.0` 的语义。
